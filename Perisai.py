...
\033[0;31m╚════════════════════════════════════════════════════════════╝\033[0m
\033[33m╔════════════════════════════════════════════════════════════╗\033[0m
\033[33m║\033[47m          BY:J4ncoksozan     \033[33mNSB• BA313 script                 \033[47m║\033[0m
\033[33m╚════════════════════════════════════════════════════════════╝\033[0m
""")
...
def handleStatusCodes(status_code):
	...
	sys.stdout.flush()
	print("\033[100m \033[32mNUSAIBAH \033[34mAttack \033[33mStarting\033[0m \033[7m" +(url)+ " \033[0m")
	sys.stdout.flush()
	if status_code == 429:
